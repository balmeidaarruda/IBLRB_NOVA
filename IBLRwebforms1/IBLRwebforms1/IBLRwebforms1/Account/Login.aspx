<%@ Page Title="Logar" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.vb" Inherits="IBLRwebforms1.Login" %>

<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <hgroup class="title">
       <h1><img src="../Images/lock.png" /></h1>
        <h1><%: Title %>.</h1>
    </hgroup>
