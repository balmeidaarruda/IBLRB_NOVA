<%@ Page Title="Contato" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.vb" Inherits="IBLRwebforms1.Contact" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <section class="contact">
        ...
        <p>
            Rua Raraguaçu<br />
            Vila Brasilia - Aparecida de Goiânia - GO
        </p>
    </section>
</asp:Content>