<%@ Page Title="Despesas" Language="vb" AutoEventWireup="false" MasterPageFile="~/Paginas/Site.Master" CodeBehind="pgCadastrarDespesas.aspx.vb" Inherits="IBLRwebforms1.pgCadastrarDespesas" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <h2 class="barraTituloSessao">Cadastro de Despesas</h2>
            <div>
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td class="auto-style2">
                            <asp:Label ID="lblTipoDespesa" runat="server" Text="Tipo despesa"></asp:Label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ddTipoDespesa" ErrorMessage="Tipo Despesa" ForeColor="red" ValidationGroup="2">*
                            </asp:RequiredFieldValidator>
                        </td>
                        <td class="auto-style4">
                            <asp:Label ID="lblValorDespesa" runat="server" Text="Valor Despesa(R$)"></asp:Label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtValorDespesa" ErrorMessage="Valor Despesa" ForeColor="red" ValidationGroup="2">*
                            </asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td class="auto-style3">
                            <asp:DropDownList ID="ddTipoDespesa" runat="server" BackColor="White" DataTextField="Descricao" DataValueField="id" Width="100%" Height="25px">
                            </asp:DropDownList>
                        </td>
                        <td class="auto-style5">
                            <asp:TextBox ID="txtValorDespesa" runat="server" Width="90%"></asp:TextBox>
                        </td>
                        <td class="style13">
                    ...
                    <tr>
                        <td class="style22" colspan="3">
                            <asp:Label ID="lblDespesasRelacionados" runat="server" Text="Despesas Relacionados"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="labelCampos" colspan="3">
                            <asp:GridView ID="gdDespesas" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="TipoDespesa.Id" HeaderText="Cod.TpDespesa" />
                                    <asp:BoundField DataField="TipoDespesa.Descricao" HeaderText="Descricao" />
                                    ...
                                    <asp:BoundField DataField="ValorDespesa" HeaderText="Valor Despesa" />
                                </Columns>
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="barraTituloSessao" colspan="3">
                            <asp:Label ID="lblConsultarDespesas" runat="server" Text="Consultar Despesas"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="style22" colspan="3">
                    ...
                    <tr>
                        <td class="auto-style6">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtDataInicio" ErrorMessage="Data Início" ForeColor="red" ValidationGroup="1">*
                            </asp:RequiredFieldValidator>
                        </td>
                        <td class="auto-style8">
                            <asp:Label ID="lblDataFim" runat="server" Text="Data Fim"></asp:Label>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtDataFim" ErrorMessage="Data Fim" ForeColor="red" ValidationGroup="1">*
                            </asp:RequiredFieldValidator>
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="width: 700px">
                            <asp:ImageButton ID="btnConsultarDespesas" runat="server" CausesValidation="true" CommandName="ConsultarDespesas" Height="16" ImageUrl="~/images/searchpb.png" ToolTip="Buscar dados" Width="16px" ValidationGroup="1" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="labelCampos" colspan="3" style="background-color: White;">
                            <div style="overflow: scroll; height: 300px; background-color: White;">
                                ...
                                <asp:GridView ID="gdDespesaConsulta" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                    ...
                                    <Columns>
                                        <asp:TemplateField ShowHeader="true" HeaderText="Editar" ItemStyle-Width="20px">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEditarDespesas" runat="server" CausesValidation="false"
                                                    CommandName="EditarDespesas" ImageUrl="~/images/editpb.png" ToolTip="Editar dados" Width="16px" Height="16" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:BoundField DataField="Id" HeaderText="Id" />
                                        <asp:BoundField DataField="Congregacao.id" HeaderText="Cod.Congre" Visible="false" />
                                        <asp:BoundField DataField="Congregacao.nome" HeaderText="Congregacao" />
                                        <asp:BoundField DataField="TipoDespesa.ID" HeaderText="Cod.TpDesp" Visible="false" />
                                        <asp:BoundField DataField="TipoDespesa.Descricao" HeaderText="Descricao" />
                                        <asp:BoundField DataField="DataLancamento" HeaderText="Data Lancamento" DataFormatString="{0:d}" />
                                        <asp:BoundField DataField="ValorDespesa" HeaderText="Valor Despesa" />
                                    </Columns>
                                    <EditRowStyle BackColor="#999999" />
                                    <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
