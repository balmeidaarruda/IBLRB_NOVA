<%@ Page Title="Campos" Language="vb" AutoEventWireup="false" MasterPageFile="~/Paginas/Site.Master" CodeBehind="pgCadastrarCampo.aspx.vb" Inherits="IBLRwebforms1.pgCadastrarCampo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     <div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <h2 class="barraTituloSessao">Cadastro de Campos</h2>
                <div>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td class="barraTituloSessao" colspan="3">
                                <asp:Label ID="lblConsultarCampos" runat="server" Text="Consultar Campos"></asp:Label>
                            </td>
                        </tr>
                        <tr>                            
                        ...
                        <tr>                            
                            ...
                            <td style="width: 160px">
                                <asp:ImageButton ID="btnConsultarCampos" runat="server" CausesValidation="false"
                                    CommandName="ConsultarCampos" ImageUrl="~/images/searchpb.png" ToolTip="Buscar dados" Width="16px" Height="16" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="labelCampos" colspan="3" style="background-color: White;">
                                <div style="overflow: scroll; height: 300px; background-color: White;">
                                    <asp:GridView ID="gdCampos" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                        ...
                                        <Columns>
                                            <asp:TemplateField ShowHeader="true" HeaderText="Editar" ItemStyle-Width="20px">
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="btnEditarCampos" runat="server" CausesValidation="false"
                                                        CommandName="EditarCampos" ImageUrl="~/images/editpb.png" ToolTip="Editar dados" Width="16px" Height="16" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td class="barraTituloSessao">
                                <asp:Label ID="lblDadosCampos" runat="server" Text="Dados do campo"></asp:Label>
                            </td>
                        </tr>
